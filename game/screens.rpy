...
style navigation_button_text:
    ...
    font "fonts/myloveletter.ttf"
    outlines [ (absolute(2), "#560319", absolute(0), absolute(0)) ]
    xalign 0.5
...
screen preferences():
    ...
    use game_menu(_(""), scroll="viewport"):
        imagemap:
            ground "menuUI/options_idle.png"
